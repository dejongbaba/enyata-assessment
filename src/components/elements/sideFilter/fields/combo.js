        ...
        <Field name={name}>
            {({ field: { onChange, onBlur, value }, meta: { touched, error }, form: { setFieldValue } }) => {
                ...
                const onSelect = (item) => {
                    ...
                    console.log("inside on select", { item, value });
                                ...
                                <>
                                    ...
                                    <div className="relative group">
                                        ...
                                        {filteredOption.length === 0 && query !== "" && (
                                            <Combobox.Options className="absolute z-40 mt-1 max-h-60 w-full overflow-auto bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                                                <div className="relative cursor-default select-none py-2 px-4 text-sm text-slate-700">
                                                    No result found.
                                                </div>
                                        ...
                                        {filteredOption.length > 0 && (
                                            <Combobox.Options className="absolute z-30 mt-1.5 max-h-60 w-full divide-y divide-slate-100 overflow-auto bg-white py-0.5 sm:text-sm shadow-lg shadow-slate-300 ring-1 ring-black ring-opacity-5 focus:outline-none">
