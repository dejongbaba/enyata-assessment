...
const PinItem = ({
    ...
    secret,
    type,
    className = "border w-10 h-10 text-xl bg-slate-100 border-slate-100 block text-center font-medium w-full py-3 placeholder-slate-400 rounded-sm focus:ring-black focus:border-black focus:shadow-none caret-primary disabled:bg-slate-100",
    autoSelect,
    inputMode,
    initialValue = "",
