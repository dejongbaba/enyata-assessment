...
export default function Component({ onSubmit, name, code, options, searchFunc }) {
    ...
    const validationSchema = Yup.object().shape({
        ...
        key: Yup.string().required(), // as select field
                        ...
                        <form method="post" className="w-full flex flex-col" onSubmit={handleSubmit}>
                            ...
                            <div className="w-full pb-2">
                                <MultiSelect
                                    ...
                                    optionClass="border-0 inline-flex font-medium w-full py-1.5 placeholder-gray-400 text-sm cursor-pointer justify-center items-center !ring-0"
